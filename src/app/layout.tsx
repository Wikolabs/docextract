...
export const metadata: Metadata = { title:"DocExtract — Extraction documentaire IA et OCR intelligent", description:"DocExtract analyse vos factures, contrats et formulaires avec l'IA et livre les donnees structurees en JSON propre, pret a brancher sur votre ERP ou CRM." };
